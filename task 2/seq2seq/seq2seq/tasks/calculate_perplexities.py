...
class CalculatePerplexities(InferenceTask):
  ...
  def __init__(self, params):
    super(CalculatePerplexities, self).__init__(params)
  ...
  def after_run(self, _run_context, run_values):
    ...
    for fetches in unbatch_dict(fetches_batch):
      ...
      predicted_tokens_str = self.params["delimiter"].join(predicted_tokens).split(
          "SEQUENCE_END")[0]
